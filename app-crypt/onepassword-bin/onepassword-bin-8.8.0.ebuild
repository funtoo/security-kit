...
HOMEPAGE="https://releases.1password.com/linux/8.8/"
SRC_URI="https://downloads.1password.com/linux/tar/stable/x86_64/1password-8.8.0.x64.tar.gz -> onepassword-bin-8.8.0.tar.gz"
